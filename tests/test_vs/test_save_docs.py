...
class TestPrepDocsPersonalData:
    ...
    def test_single_chunk(self):
        test_metadata = {"user_id": uuid.uuid4()}
        text = """
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
        """
        doc = _prep_docs_personal_data(texts=[text], metadatas=[test_metadata])
        assert isinstance(doc, list)
        assert isinstance(doc[0], Document)
        assert len(doc) == 1

        # TODO: Expand tests for multiple chunks, as well as multiple documents / metadatas provision.